...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [JPUSHService setupWithOption:launchOptions appKey:@"3b43bfd02af2e6f0d15c9f75"
                          channel:@"App Store"
                 apsForProduction:1
...
- (void)applicationWillResignActive:(UIApplication *)application {
    ...
    // Use this method to pause ongoing tasks, disable timers, and invalidate graphics rendering callbacks. YouXis should use this method to pause the YouXi.
}
